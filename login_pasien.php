...
<body>
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="row bg-white shadow rounded overflow-hidden" style="width: 70%;">
            <div class="col-md-5 d-flex flex-column justify-content-center align-items-center bg-yellow p-4">
                <img src="assets/images/patient-icon.png" alt="Pasien" class="rounded-circle" style="width: 60%;">
            </div>
            <div class="col-md-7 p-4">
                ...
                <div class="text-center mt-3">
                    <a href="registrasi_pasien.php" class="text-green">Belum punya akun? Registrasi di sini</a><br>
                    <a href="login_dokter.php" class="text-muted">Login sebagai dokter</a>
                </div>
